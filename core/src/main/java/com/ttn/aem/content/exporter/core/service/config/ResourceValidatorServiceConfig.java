...
public @interface ResourceValidatorServiceConfig {
    ...
    @AttributeDefinition(name = "Excluded Properties", description = "Properties configured here will be blocked by content exporter service in whichever component they appear.")
